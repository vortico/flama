...
class MarshmallowAdapter(Adapter):
    def build_field(self, field_type: type, required: bool, default: typing.Any) -> marshmallow.fields.Field:
        if required:
    ...
    def build_schema(
        ...
        if pagination:
            ...
            ), "Parameter 'pagination_schema_name' must be given to create a paginated schema"
