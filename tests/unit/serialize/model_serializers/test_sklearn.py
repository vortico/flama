...
class TestCaseSklearnModelSerializer:
    """Cover the sklearn slice of :class:`flama.serialize.model_serializers.sklearn.ModelSerializer`."""
    ...
    def test_info(self, model_attrs: dict, expected: dict | None) -> None:
        spec = SPECS[_FRAMEWORK]
