...
class TestCaseResolutionTree:
    ...
    def test_build(
        ...
        with exception:
            tree = ResolutionTree.build(parameter, context_cls, components)
    ...
    async def test_value(self, context_cls, components, uuid_mock, parameter, calls, uuid_calls):
